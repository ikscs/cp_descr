...
import {
    ...
    type GridFilterModel as MuiGridFilterModel,
    type GridSortModel as MuiGridSortModel,
...
import type { Position, GridFilterModel, GridSortModel } from '../../types/models'; // Импортируем Position
