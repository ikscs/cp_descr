...
import {
    ...
    type GridFilterModel as MuiGridFilterModel, // MUI's filter model type
    type GridSortModel as MuiGridSortModel,     // MUI's sort model type
    // GridValueFormatter,
...
import type { Employee, GridFilterModel, GridSortModel } from '../../types/models'; // Custom types for API
