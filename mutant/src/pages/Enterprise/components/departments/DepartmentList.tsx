...
import {
    ...
    type GridFilterModel as MuiGridFilterModel, // Переименовываем, чтобы избежать конфликта
    type GridSortModel as MuiGridSortModel,     // Переименовываем
...
import type { Department, GridFilterModel, GridSortModel } from '../../types/models'; // Наши типы
