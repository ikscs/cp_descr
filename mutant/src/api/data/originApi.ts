...
const getCustomerOrigins = async (): Promise<CustomerOrigin[]> => {
  console.log('[originApi] getCustomerOrigins called');
  const res = await axios.get<CustomerOrigin[]>('v_customer_origin/');
  return res.data;
}
 ...
 */
const getOrigins_OLD = async (point_id?: number): Promise<Origin[]> => {
  console.log(`[originApi] getOrigins called for point_id: ${point_id}/`);
  try {
    const params: any = {
 ...
 */
const createOrigin_ = async (data: CreateOriginData): Promise<Origin> => {
  console.log('[originApi] createOrigin called with data:', data);
 ...
 *
const updateOrigin_OLD = async (id: number, data: UpdateOriginData): Promise<Origin> => {
  console.log('[originApi] updateOrigin called for id:', id, 'with data:', data);
 ...
 */
const deleteOrigin_ = async (id: number): Promise<boolean> => {
  console.log('[originApi] deleteOrigin called for id:', id);
 ...
 */
const getCustomerOrigins_ = async (customerId: number): Promise<CustomerOrigin[]> => {
