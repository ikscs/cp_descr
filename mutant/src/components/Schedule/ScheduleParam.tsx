...
import { executeReportQuery, getReports, getReportsLang, type Report } from "../../api/data/reportToolsDrf";
...
const ScheduleParam: FC<ScheduleParamProps> = ({ reportId, params, onClose, onSave}) => {
    ...
    const handleExecute = (params: ParamValue[]) => {
        const lang = i18n.language as LocaleKey;
        executeReportQuery(reportId, params, lang);
        console.log(params)
    };

    const handleAcceptParams = (params: ParamValue[]) => {
