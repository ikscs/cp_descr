import { useEffect, useMemo, useState, createContext, useCallback, /*useContext,*/ } from "react"; 
import DataGrid, {
    // Row,
    SelectColumn,
    textEditor,
...
function Grid(props: IGridProps) {
    ...
    console.log('Grid props, selectedPosition', props, selectedPosition)
    return (
    < div >
