...
import { fetchData, IFetchResponse } from '../data/fetchData';
// Импортируем toExcel и его интерфейс колонки
import { toExcel, IGridColumn } from './toExcel';
// Импортируем тип для where из genericApiTypes для единообразия
import { IWhereClause } from '../data/genericApiTypes';
