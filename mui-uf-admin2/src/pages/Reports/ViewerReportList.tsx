...
import { Report } from '../../api/data/reportTools'; // Import Report type
...
const VIEWER_ALLOWED_REPORT_IDS: number[] = [26, 27, 28, 29, 30, ]; // Example: Allow reports with ID 1, 3, or 5
